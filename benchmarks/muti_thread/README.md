...
This folder measures performance. It helps you detect if changes make behavior faster or slower.

## Current Snapshot
- Path: benchmarks/muti_thread
- Vitte files: 30
- Markdown files: 1
- Test-like files: 1
- Benchmark-like files: 0
...
## Practical Tip
Compare before/after numbers when logic changes.
